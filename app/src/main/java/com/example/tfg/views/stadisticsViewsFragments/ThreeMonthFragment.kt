...
class ThreeMonthFragment : Fragment() {

    private var _binding: FragmentThreeMonthBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentThreeMonthBinding.inflate(inflater, container, false)
        return binding.root   }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val recyclerView=binding.reciclerThreeMonth
